...
def lookup_plant(plant_name: str) -> dict:
    ...
    return {
        "found": False,
        "name": normalized,
        "message": f"{plant_name} is not in the plant database. Inform the user that you don't have specific care data for this plant, and offer general guidance based on what they describe.",
    }
